...
namespace EmployeesCh12.Models
{
    public class EmployeeContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // ===== one-to-many: Location -> DepartmentLocations =====
            modelBuilder.Entity<DepartmentLocation>()
            ...
            // ===== one-to-many: Benefits -> Employees =====
            // (multiple employees can share the same benefits package)
            modelBuilder.Entity<Employee>()
                .HasOne(e => e.Benefits)
                .WithMany(b => b.Employees)
                .HasForeignKey(e => e.BenefitsID);

            // ===== Seed data from your instructor =====
