...
namespace EmployeesCh12.Controllers
{
    public class BenefitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Category,Dental,Health,Vision,LifeIns")] Benefits benefits)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Category,Dental,Health,Vision,LifeIns")] Benefits benefits)
        {
            if (id != benefits.ID)
            {
                return NotFound();
