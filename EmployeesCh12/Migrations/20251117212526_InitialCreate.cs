        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LifeIns = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, true, true, 100000, true },
                    { 3, 2, true, true, 100000, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "2200 Park Ave", 0, "49696" },
                    { 2, "2200 Park Ave", 1, "49696" },
                    { 3, "2200 Park Ave", 2, "49696" },
                    { 4, "2100 Park Ave", 3, "49696" },
                    { 5, "6 Hickory Blvd.", 3, "49696" },
                    { 6, "6 Hickory Blvd.", 4, "49696" }
                });
